namespace Rees.TangyFruitMapper
{
    internal class MapResult
    {
        ...
        /// </summary>
        public required IReadOnlyDictionary<string, AssignmentStrategy> DtoToModelMap { get; set; }

        public required Type DtoType { get; set; }

        public string MapperName => GetMapperName(DtoType, ModelType);

        public required ConstructionStrategy ModelConstructor { get; set; }

        /// <summary>
        ///     Gets a map with the Model Property name as the key and the property name from the Dto as the value.
        /// </summary>
        public required IReadOnlyDictionary<string, AssignmentStrategy> ModelToDtoMap { get; set; }
